...
#save.image("/Users/jamesdiao/Documents/Kohane_Lab/2016-paper-ACMG-penetrance/Environ_2016-10-16")
#load("/Users/jamesdiao/Documents/Kohane_Lab/2016-paper-ACMG-penetrance/Environ_2016-10-16")
...
These plots are from (4a) - 1000 Genomes Fraction with 1+ Non-Reference Site, but can be replicated for plots 2(ab) and 3(ab) as well. 
...
allele.freq <- data.frame("Pattern" = tags %>% unique,
                   COUNT_1000G = freq_1000g.count$AF_1000G, CALC_1000G = freq_1000g.calc$AF_1000G, CALC_EXAC = freq_exac.calc$AF_EXAC)
...
> 2. Comparisons of AF(disease) by dataset or method
...
ratio_diff(allele.freq$CALC_1000G, allele.freq$COUNT_1000G, title = "Counting v. Calculation (1000 Genomes)") %>% invisible
ratio_diff(allele.freq$CALC_EXAC, allele.freq$CALC_1000G, title = "1000 Genomes v. ExAC (Calculation)") %>% invisible
par(op)
```

The median AF(disease) ratio between counting and calculation is: `r ratio_diff(allele.freq$CALC_1000G, allele.freq$COUNT_1000G, title = "Counting v. Calculation (1000 Genomes)")`. <br />
The median AF(disease) ratio between ExAC and 1000 Genomes is: `r ratio_diff(allele.freq$CALC_EXAC, allele.freq$COUNT_1000G, title = "1000 Genomes v. ExAC")` <br />

> 3. Penetrance as a function of allelic heterogeneity: P(V|D) = 0.001, 0.02, 0.5
...
> 4. Penetrance as a function of prevalence (when a range is presented)
