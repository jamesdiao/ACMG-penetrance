...
data.frame(Disease = doubles$Disease, Prevalence_Ratio = round(doubles$Inverse_Prevalence_1/doubles$Inverse_Prevalence_2,1)) %>% arrange(Prevalence_Ratio) %>% mutate(Prevalence_Ratio = sprintf("%.1f",Prevalence_Ratio)) %>% pander
```
