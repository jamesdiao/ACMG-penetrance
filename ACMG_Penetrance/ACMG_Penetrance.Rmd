...
<br />
The distribution follows Binom(n,p), n = # samples and p = allele frequency, if trials are independent.  
Because n is large and p is small, we may be justified in using a Poisson approximation to the binomial.  
