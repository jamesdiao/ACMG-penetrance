...
# save.image("/Users/jamesdiao/Documents/Kohane_Lab/2016-paper-ACMG-penetrance/Environ_2016-11-22")
# load("/Users/jamesdiao/Documents/Kohane_Lab/2016-paper-ACMG-penetrance/Environ_2016-11-22")
...
plot_ind_test <- function() {
  ...
  plot(sapply(levels(ind_test_data$DISEASE), function(d) {
    ind_test_data %>% filter(DISEASE == d) %>% 
      ...
      select(RATIO) %>% unlist
  }) %>% data.frame %>% gather(Disease, Data) %>% filter(is.finite(Data)) %>%
